<div align="center">
  ...
  <p><strong>buchida CLI — AI エージェントのためのメール API</strong></p>
...
@buchida/cli は AI エージェントのために作られたメール API の公式コマンドラインインターフェースです。buchida は CLI、MCP サーバー、そして 5 言語の SDK (Node、Python、Go、Ruby、Java) を提供しており、すべて同じ REST API 表面を共有しています。`@buchida/email` テンプレートは韓国語、日本語、中国語をネイティブにレンダリングします。
